...
const cols = [
   ...
   },
   {
      ...
      render: (row) => h(
         ...
         {
            default: () => mapOperations.getByValue(row?.serviceName)
         }
      ),
   },
   {
   ...
   },
   {
      ...
      render: (row) => h(
         NTag,
         {
            type: getTagTypeByElapsedTime(row?.elapsedTime),
            bordered: false,
         },
         {
         ...
         <n-popover placement="top" trigger="click">
            ...
            <n-form :model="entity.find">
               ...
               <n-form-item label="id" path="id">
                  <n-input v-model:value="entity.find.id" :allow-input="inputValidator.onlyAllowNumber"
                           clearable
                           placeholder="输入id"/>
               </n-form-item>
               <n-form-item label="操作类型" path="type">
                  <n-select v-model:value="entity.find.type" :options="typeOptions" clearable
                            placeholder="选择操作类型"/>
               </n-form-item>

               <n-form-item label="数据类型" path="serviceName">
                  <n-select v-model:value="entity.find.serviceName" :options="serviceNameOptions" clearable
                            placeholder="选择数据类型"/>
               </n-form-item>
            </n-form>
            <n-form :model="filter">
